...
(function (document) {
    ...
    var $formRadios = document.querySelectorAll('.quiz-form-radios'),
		...
		$linkAgain0 = document.querySelector('.link-again0'),
    ...
    loop($quizForm, function ($form) {
        $form.addEventListener("submit", function (e) {
            e.preventDefault();
            var $parent = this.parentNode, next = Array.prototype.slice.call($quizForm).indexOf(this) + 1;
	...
	$linkAgain0.addEventListener("click", function (e) {
